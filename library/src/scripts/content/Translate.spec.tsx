...
describe("<Translate />", () => {
    it("renders nothing when given an empty string source", () => {
        ...
        expect(rendered.container.innerHTML === "");
    });
    ...
    it("translates value from the translation list", () => {
        ...
        expect(rendered.container.innerHTML === "test translated");
    });
    ...
    it("can intepolate a self closing component", () => {
        ...
        testStrings.forEach(str => {
            const rendered = render(<Translate source={str} c0={<TestComponent />} />);
            expect(rendered.container.innerHTML).equals(expected);
        });
    });
    ...
    it("can intepolate multiple self closing components", () => {
        ...
        const rendered = render(<Translate source={testString} c0={<TestComponent />} c1={<TestComponent2 />} />);
        expect(rendered.container.innerHTML).equals(expected);
    });
    ...
    it("can intepolate a string with children", () => {
        ...
        const rendered = render(<Translate source={testString} c0={c0} />);
        expect(rendered.container.innerHTML).equals(expected);
    });
});
